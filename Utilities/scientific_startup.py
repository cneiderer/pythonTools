...
#==============================================================================
# Import Necessary Utilties
#==============================================================================
from Utilities.Utilities import clc, clearConsole # Command Line Clear
from Utilities.Utilities import pwd # Print Working Directory
from Utilities.Utilities import closeAll # Close All Figures
...
try:
    ...
    import statsmodels.version
except ImportError:
    __has_statsmodels = False
...
if __has_sklearn:
    __imports += ", SciKit-Learn %s" % sk.__version__
if __has_statsmodels:
    __imports += ", StatsModels %s" % statsmodels.version.version
if __has_pandas:
